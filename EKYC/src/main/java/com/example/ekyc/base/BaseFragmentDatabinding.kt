...
internal abstract class BaseDataBindingFragment<BD : ViewDataBinding, VM> :
    ...
    private lateinit var mainViewModel: SDKMainViewModel
    ...
    override fun onCreateView(
        ...
        mainViewModel = ViewModelProvider(requireActivity())[SDKMainViewModel::class.java]
...
//    }
    ...
    fun getMainViewModel(): SDKMainViewModel {
